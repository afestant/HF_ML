...
void runAnalysis()
{
    ...
    gInterpreter->LoadMacro("AliAnalysisTaskSED0Mass_AF.cxx++g");
    //AliAnalysisTaskSED0Mass_AF *task = reinterpret_cast<AliAnalysisTaskSED0Mass_AF*>(gInterpreter->ExecuteMacro("AddTaskD0Mass_AF.C"));
    AliAnalysisTaskSED0Mass_AF *task = reinterpret_cast<AliAnalysisTaskSED0Mass_AF*>(gInterpreter->ProcessLine(Form(".x %s (%d,%d,%d,%d,%d,%d,%f,%f,\"%s\",\"%s\",\"%s\",%d,%d,%d,%d,%d,%d,%d,%d,%d)",gSystem->ExpandPathName("AddTaskD0Mass_AF.C"),0, kTRUE, kFALSE, kFALSE, 1, 0, 0., 80., "_080", "./D0Cuts_Y_R5.root", "D0toKpiCuts",kFALSE, kFALSE, kFALSE,kFALSE, kFALSE, kFALSE,kFALSE, kFALSE, kTRUE)));
    ...
    gROOT->LoadMacro("AliAnalysisTaskSED0Mass_AF.cxx++g");
    gROOT->LoadMacro("AddTaskD0Mass_AF.C");
    AliAnalysisTaskSED0Mass_AF *task = AddTaskD0Mass_AF(0, kTRUE, kFALSE, kFALSE, 1, 0, 0., 80., "_080", "./D0Cuts_Y_R5.root", "D0toKpiCuts",kFALSE, kFALSE, kFALSE,kFALSE, kFALSE, kFALSE,kFALSE, kFALSE, kTRUE);
    ...
    if(local) {
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisTaskSED0Mass_AF.cxx AliAnalysisTaskSED0Mass_AF.h");
        alienHandler->SetAnalysisSource("AliAnalysisTaskSED0Mass_AF.cxx");
