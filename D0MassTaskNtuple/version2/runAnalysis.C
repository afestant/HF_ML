...
#include "AliAnalysisTaskSED0_TreeMVA.h"
#endif
...
void runAnalysis()
{
    ...
    if(local) {
        ...
        //chainAOD->Add("../AODFiles_refiletring/MC/AliAOD.root");
        //chainAODfriend->Add("../AODFiles_refiletring/MC/AliAOD.VertexingHF.root");
