#ifndef AliAnalysisTaskSED0Mass_AF_H
#define AliAnalysisTaskSED0Mass_AF_H
...
///*************************************************************************
/// \class Class AliAnalysisTaskSED0Mass_AF
...
class AliAnalysisTaskSED0Mass_AF : public AliAnalysisTaskSE
{
 public:

  AliAnalysisTaskSED0Mass_AF();
  AliAnalysisTaskSED0Mass_AF(const char *name,AliRDHFCutsD0toKpi* cuts);
  virtual ~AliAnalysisTaskSED0Mass_AF();
  ...
  void SetArray(Int_t type=AliAnalysisTaskSED0Mass_AF::kD0){fArray=type;}
  enum{kD0,kLS};
 ...
 private:
  ...
  AliAnalysisTaskSED0Mass_AF(const AliAnalysisTaskSED0Mass_AF &source);
  AliAnalysisTaskSED0Mass_AF& operator=(const AliAnalysisTaskSED0Mass_AF& source); 
  ...
  Float_t GetTrueImpactParameter(AliAODMCHeader *mcHeader, TClonesArray* arrayMC, AliAODMCParticle *partD0) const ;
    ...
    void  FillCandidateNtuple(AliAODRecoDecayHF2Prong *part, TClonesArray *arrMC, AliRDHFCutsD0toKpi *cuts, AliAODEvent* aod);
  ...
  Bool_t    fEnablePileupRejVZEROTPCout;
    Bool_t fFillNtuple;
    TNtuple *fCandidateNtuple; //!

  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskSED0Mass_AF,24); /// AliAnalysisTaskSE for D0->Kpi
  /// \endcond
};
